...
const Rockets = () => {
    ...
    return (
        <div id='rocket' className='bg-[#121212] max-width py-10'>
            <h3 className="text-center text-[3rem] font-medium text-transparent bg-clip-text bg-gradient-to-r from-custom-gradient-start to-custom-gradient-end">
                All Rockets
            </h3>
